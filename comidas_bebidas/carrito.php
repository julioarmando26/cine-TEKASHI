...
if(isset($_GET['id']) && is_numeric($_GET['id'])){
    ...
    $resultado = $alimentos->mostrarPorId($id);
    ...
    if(isset($_SESSION['carrito'])){ //SI EL CARRITO EXISTE
        //SI EL ALIMENTO EXISTE EN EL CARRITO
        if(array_key_exists($id,$_SESSION['carrito'])){
            actualizarAlimentos($id);
        }else{
            //  SI EL CARRITO NO EXISTE EN EL CARRITO
            agregarAlimentos($resultado, $id);
        }
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav pull-right">
            <li>
              <a href="" class="btn">CARRITO <span class="badge"><?php print cantidadAlimentos(); ?></span></a>
            </li> 
          </ul>
        </div><!--/.nav-collapse -->
      </div>
    ...
    <div class="container" id="main">
            ...
            <div class="row">
                    ...
                    <div class="pull-right">
                        <a href="tarjeta-credito/index.php" class="btn btn-success">Finalizar Compra</a>
                    </div>
            </div>
